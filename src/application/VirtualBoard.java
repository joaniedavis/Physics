...
public class VirtualBoard {
	...
	public VirtualBoard() {
		...
		// TODO: Create a hash of Conditions (String condition labels mapped to
		// boolean values), and initialize it here
	...
	/*
	 * Initializes all of the VirtualSwitch Objects and adds them to the
	 * vSwitches ArrayList
	 */
	private void InitializeVirtualSwitches() {

		// initialize the VirtualSwitches
		VirtualSwitch ValveEnable_S2 = new VirtualSwitch("Enable Valves", "Enabled", "Disabled", SwitchState.FALSE,
				false);
		VirtualSwitch TurboNLK_m_S3 = new VirtualSwitch("Turbo Pump Interlock", "Bypass", "Normal", SwitchState.FALSE,
				false);
		VirtualSwitch BLV_AutoClose_S6 = new VirtualSwitch("Beam Line Valve", "Auto", "Close", SwitchState.FALSE,
				false);
		VirtualSwitch PV_AutoClose_S7 = new VirtualSwitch("Turbo Pump Valve", "Auto", "Close", SwitchState.FALSE,
				false);
		VirtualSwitch LockValve_AutoClose_S8 = new VirtualSwitch("Lock Valve", "Auto", "Close", SwitchState.FALSE,
				false);
		VirtualSwitch LockRoughValve_AutoClose_S9 = new VirtualSwitch("Lock Roughing Valve", "Auto", "Close",
				SwitchState.FALSE, false);
		VirtualSwitch TurboRoughValve_AutoClose_S10 = new VirtualSwitch("Turbo Pump Rough Valve", "Auto", "Close",
				SwitchState.FALSE, false);
		VirtualSwitch VentValve_AutoClose_S11 = new VirtualSwitch("Vent Valve", "Auto", "Close", SwitchState.FALSE,
				false);
		VirtualSwitch VentLockChamber_m_S12 = new VirtualSwitch("Vent Lock and Chamber", "Vent", "Standby",
				SwitchState.FALSE, true);
		VirtualSwitch VentLock_m_S11 = new VirtualSwitch("Vent Lock", "Vent", "Standby", SwitchState.FALSE, true);
		VirtualSwitch PumpLockChamber_m_S14 = new VirtualSwitch("Pump Lock and Chamber", "Pump", "Standby",
				SwitchState.FALSE, false);
	...
	/*
	 * TODO: Initializes all of the LED objects and adds them to the leds
	 * ArrayList
	 */
	...
	public HashMap<String, Boolean> getConditionMap() {
		return conditionMap;
	}
